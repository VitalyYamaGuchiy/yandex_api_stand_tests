...
<!--Этот язык приложения указан в требованиях к Яндекс Прилавку.
Если это не так, то тогда и в требованиях нужно исправить. 
Скриншот требований: https://disk.yandex.ru/i/QVCcKkePv0OrmQ
Ссылка на требования: https://wiki.yandex.ru/homepage/trebovanijakjandeksprilavok/-->
...
>    "Authorization": "Bearer https://11f92800-c0ef-4176-9084-2521f1ef86b8.serverhub.praktikum-services.ru"
> }
> ```
